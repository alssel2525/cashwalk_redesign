		...
		<div className={"main__visual"}>
			<div className={"main__visual__container"}>
				...
				<div className={"link_container"}>
					<LinkDownload
						link={"https://play.google.com/store/apps/details?id=com.cashwalk.cashwalk"}
						icon={android} text={"앱 다운로드"}/>
					<LinkDownload
						link={"https://apps.apple.com/ph/app/%EC%BA%90%EC%8B%9C%EC%9B%8C%ED%81%AC/id1220307907"}
						icon={apple} text={"앱 다운로드"}/>
				</div>
			</div>
